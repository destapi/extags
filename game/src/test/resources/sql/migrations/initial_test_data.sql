...
-- game
insert into Game (title, organizerRef) values ('eye of a tiger', (select id from Player where screenName = 'alligator'));
insert into Game (title, organizerRef) values ('ribeye steak', (select id from Player where screenName = 'alligator'));
